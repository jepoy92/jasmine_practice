...
describe("Calculator", () => {
    describe("Test different additions", () => {
        it("The total should be 5.", () => {
            const result = performOperation(0, "+", 5);
            expect(result).toBe(5);   
        });
        it("The total should be 10.", () => {
            const result = performOperation(5, "+", 5);
            expect(result).toBe(10);   
        });
    });

    it("should subtract number to the total.", () => {
        const result = performOperation(30, "-", 5);
    ...
    it("should throw error when dividing by 0", () => {
        expect(() => performOperation(10, "/", 0)).toThrowError("Cannot divide by zero");
    })
})